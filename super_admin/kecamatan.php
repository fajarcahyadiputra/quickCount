					...
					<table class="table table-bordered table-striped table-hover" id="tableKecamatan" style="width: 100%">
                        ...
                        <?php
                         ...
                         <tr>
                                ...
                                <td>
                                <a class="btn btn-danger" onclick="return confirm('Yakin mau hapus ?')" href="aksiHapus.php?id=<?php echo $data['id'] ?>&hapus=dataKecamatan"><i class="fa fa-trash"></i></a>
                                <button data-id="<?php echo $data['id'] ?>" id="tombolEdiKecamatan" class="btn btn-info"><i class="fa fa-edit"></i></button>
                                </td>
                         </tr>
                        <?php } ?>
					</tbody>
...
<div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form method="post" action="aksiTambah.php?tambah=data_kecamatan">
				...
				<div class="modal-footer">
					...
					<button type="submit" name="tambahKecamatan" class="btn btn-primary">Tambah</button>
				</div>
			</form>
		</div>
	</div>
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form id="form_edit" method="post" action="aksiEdit.php?edit=dataKecamatan">
...
<script>
  ...
  $(document).ready(function(){
    $(document).on('click','#tombolEdiKecamatan', function(){
      let id = $(this).data('id');
      
      $.ajax({
        url : 'getData.php?get=dataKecamatan',
        data : {'id': id},
        type : 'post',
        dataType : 'json',
        success: function(hasil){
            $('#form_edit').html(`<div class="modal-body">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
					<button type="submit" name="editKecamatan" class="btn btn-primary">Edit</button>
				</div>`)
